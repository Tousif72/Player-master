...
import com.ak93.exoplayerexample.api.Api;
import com.ak93.exoplayerexample.models.LoadJason;
import com.ak93.exoplayerexample.models.Meta;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url_ = "https://transcription-asr.s3-ap-southeast-1.amazonaws.com/GCjWdk8GZNmL04DS9hfzYM2dm2EtcOG3yMN63go6.mpga";

//        prepareExoPlayerFromURL(Uri.parse("https://transcription-asr.s3-ap-southeast-1.amazonaws.com/GCjWdk8GZNmL04DS9hfzYM2dm2EtcOG3yMN63go6.mpga "));
        prepareExoPlayerFromURL(Uri.parse(url_));
    }
    ...
    private void initSeekBar() {
        ...
        public void loadDataCall() {

            Api userAPICall = RetroFitEngine.getRetrofit().create(Api.class);
            Call<LoadJason> call = userAPICall.getAudioinfo();
...
//        progressDoalog.setMax(100);
            ...
            call.enqueue(new Callback<LoadJason>() {
                @Override
                public void onResponse(Call<LoadJason> call, Response<LoadJason> response) {
                    progressDoalog.dismiss();
                    if (response.code() == 200) {
                        try {
                            Toast.makeText(MainActivity.this, response.body()+"", Toast.LENGTH_SHORT).show();
                            LoadJason loadJason = response.body();
                            meta = loadJason.getMeta();
                        } catch (Exception e) {
                ...
                @Override
                public void onFailure(Call<LoadJason> call, Throwable t) {
                    progressDoalog.dismiss();
                }
            });
        }
